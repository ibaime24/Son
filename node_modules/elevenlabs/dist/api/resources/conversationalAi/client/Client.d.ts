...
export declare class ConversationalAi {
     ...
     */
    getKnowledgeBaseDocumentById(documentationId: string, requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.GetKnowledgeBaseReponseModel>;
    /**
     ...
     */
    getTools(requestOptions?: ConversationalAi.RequestOptions): Promise<ElevenLabs.ToolResponseModel[]>;
}
